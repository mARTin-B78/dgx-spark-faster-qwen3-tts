...
Project:
- Name: tts-dgx-spark-faster-qwen3-tts
- Working directory: /home/sparky/Docker/tts-dgx-spark-faster-qwen3-tts
- Primary repository: https://github.com/mARTin-B78/dgx-spark-faster-qwen3-tts.git
- Backup repository: https://gitea.martin-bierschenk.de/mARTin-B78/tts-dgx-spark-faster-qwen3-tts.git
- Deployment target: Self-hosted Docker container (DGX Spark, local network)
- Working title: dgx-spark-faster-qwen3-tts
